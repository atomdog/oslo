...
# reference: https://github.com/hjmeteor/speech-synthesiser/blob/fec33ab1c93a9a60f844d7850b59aa29be451388/SimpleAudio.py
...
class Audio(pyaudio.PyAudio):
    ...
    def play(self):
        ...
        sleep(0.4) # work around for a bug in some (non-blocking) audio hardware 
